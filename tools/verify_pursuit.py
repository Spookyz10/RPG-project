...
assert(not pursuit:Update(target) and pursuit.TooClose and hum.Destination.Z==4)
root.Position=vec()
assert(not pursuit:Update(target) and hum.Destination.Z==4,"coincident roots must retreat without NaN")
pursuit.Radius=8
