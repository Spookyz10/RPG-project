...
viewport = Vector2.new(390, 760)
gui.Trading:GetPropertyChangedSignal("AbsoluteSize"):Fire()
assert(trading.Composer.MobileTabs.Visible and trading.Composer.Mine.Visible and not trading.Composer.Theirs.Visible)
assert(trading.Composer.OfferSummary.Position.Y.Scale == 0.52)
click(trading.Composer.MobileTabs.Receive)
assert(not trading.Composer.Mine.Visible and trading.Composer.Theirs.Visible)
viewport = Vector2.new(1280, 720)
gui.Trading:GetPropertyChangedSignal("AbsoluteSize"):Fire()
assert(not trading.Composer.MobileTabs.Visible and trading.Composer.Mine.Visible and trading.Composer.Theirs.Visible)
